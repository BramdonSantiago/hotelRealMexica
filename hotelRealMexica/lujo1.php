            ...
            <div class="contenedor">
                <div class="habitacion-servicios">
                    <div class="imagen-habitacion-servicio">
                        <img src="img/habitacion-lujo1.jpg" alt="Habitación Sencilla">
                    </div>
                    <div class="caracteristicas-habitacion-servicio">
                        <h2>Habitación de Lujo 1 <span>$3,900.00\noche</span></h2>
                        <details open class="detalles">
                            <summary>Descripción</summary>
                            <p>Habitación de Lujo 1 muy elegante, con detalles modernos y una decoración agradable. Muy acogedoras y de gran confort; diseñadas para momentos especiales y estancias tranquilas. Las habitaciones de Lujo 1, tienen 3 camas King Size de altisima calidad.</p>
                          </details>
                        ...
                        <summary>Caracteristicas</summary>
                            <ul>
                                ...
                                <li><i class="fas fa-bath icono-caracteristicas-cuarto-hover"></i> Bañera</li>
                                ...
                                <li><i class="fas fa-bed icono-caracteristicas-cuarto-hover"></i> Camas Grandes</li>
