            ...
            <div class="contenedor">
                <div class="habitacion-servicios">
                    <div class="imagen-habitacion-servicio">
                        <img src="img/habitacion-lujo2.jpg" alt="Habitación Sencilla">
                    </div>
                    <div class="caracteristicas-habitacion-servicio">
                        <h2>Habitación de Lujo 2 <span>$4,700.00\noche</span></h2>
                        <details open class="detalles">
                            <summary>Descripción</summary>
                            <p>Habitación de Lujo 2 muy elegante, con detalles modernos y una decoración agradable. Muy acogedoras y de gran confort; diseñadas para momentos especiales y estancias tranquilas. Las habitaciones de Lujo 2, tienen 3 camas King Size de altisima calidad acompañadas de una vista al mar increible.</p>
                          </details>
