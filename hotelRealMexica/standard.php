            ...
            <div class="contenedor">
                <div class="habitacion-servicios">
                    <div class="imagen-habitacion-servicio">
                        <img src="img/habitacion-standard.jpg" alt="Habitación Sencilla">
                    </div>
                    <div class="caracteristicas-habitacion-servicio">
                        <h2>Habitación Standard <span>$2,400.00\noche</span></h2>
                        <details open class="detalles">
                            <summary>Descripción</summary>
                            <p>Habitación Standard muy elegante, con detalles modernos y una decoración agradable. Muy acogedoras y de gran confort; diseñadas para momentos especiales y estancias tranquilas. Las habitaciones standard, tienen 2 camas individuales.</p>
                          </details>
